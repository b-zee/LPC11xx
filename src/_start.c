...
const handler table[]  __attribute__ ((section(".vectors"))) = {
    ...
    _reset,        /* 0x10 - -Reserved- */
    _reset,        /* 0x14 - -Reserved- */
    _reset,        /* 0x18 - -Reserved- */
    _reset,        /* 0x1C - -Reserved- */
    _reset,        /* 0x20 - -Reserved- */
    _reset,        /* 0x24 - -Reserved- */
    _reset,        /* 0x28 - -Reserved- */
    _reset,        /* 0x2C - SVCall */
    _reset,        /* 0x30 - -Reserved- */
    _reset,        /* 0x34 - -Reserved- */
    _reset,        /* 0x38 - PendSV */
    _reset,        /* 0x3C - SysTick */
    _reset,        /* 0x40 - IRQ1 */
    _reset,        /* 0x44 - IRQ2 */
